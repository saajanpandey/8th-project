...
@inject('cities','App\Http\Controllers\city\CityController')
@inject('types','App\Http\Controllers\jobType\JobTypeController')
@inject('welcome', 'App\Http\Controllers\welcome\WelcomeController')
@section('title', 'Job Finder')
@section('contents')
    <section class="home-section section-hero overlay bg-image" style="background-image: url('/frontend/images/hero_1.jpg');"
        id="home-section">
        ...
        <div class="container">
            ...
            <div class="row mb-5 justify-content-center">
                <div class="col-md-7 text-center">
                    <h2 class="section-title mb-2">{{ $welcome->jobPosted() }} Job Listed</h2>
                </div>
            </div>

            <ul class="job-listings mb-5">
                @foreach ($welcome->jobList() as $list)
            ...
            <div class="row pagination-wrap">
                <div class="col-md-6 text-center text-md-left mb-4 mb-md-0">
                    <span>Showing {{ $welcome->jobList()->firstItem() }} - {{ $welcome->jobList()->lastItem() }} of
                        {{ $welcome->jobList()->total() }} Jobs</span>
                </div>
                {!! $welcome->jobList()->links() !!}
            </div>
        </div>
    </section>
